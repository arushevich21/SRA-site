        ...
        <div className="flex gap-2">
          {DIVISIONS.map((d) => (
            <button
              ...
              className={[
                'font-mono text-[15px] tracking-[.2em] uppercase px-4 py-2 border transition-colors cursor-pointer',
                d === division
      ...
      <div className="flex gap-1 border-b border-line mb-6">
        {CHAMP_TYPES.map((type) => (
          <button
            ...
            className={[
              'font-mono text-[15px] tracking-[.25em] uppercase px-4 py-2 -mb-px border-b-2 transition-colors cursor-pointer',
              type === champType
            ...
            <div className="flex gap-1 mb-4">
              {(['overall', 'gold', 'silver'] as const).map((view) => (
                <button
                  ...
                  className={[
                    'font-mono text-[15px] tracking-[.2em] uppercase px-3 py-1.5 border transition-colors cursor-pointer',
                    view === driverView
                      ? 'text-gold border-gold bg-gold/5'
