...
-- logos (accCarManufacturerLogoUrl in apps/cockpit/src/lib/acc/manufacturer-logo.ts,
-- keyed off ACC_CAR_MANUFACTURER_CDN_SLUGS in acc-constants.ts) can be looked
-- up reliably instead of parsing the name string.
